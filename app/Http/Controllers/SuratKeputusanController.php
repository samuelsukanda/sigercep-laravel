...
class SuratKeputusanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('sdm-hukum.surat-keputusan.index') . '?saved=1')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect(route('sdm-hukum.surat-keputusan.index') . '?updated=1')->with('success', 'Data berhasil diperbarui.');
    }
