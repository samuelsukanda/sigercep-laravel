<div class="relative overflow-x-auto shadow-md rounded-lg px-2 bg-white dark:text-white">
    <table id="peminjamanTable" class="min-w-full divide-y divide-gray-200 dark:divide-white-200 dark:text-white">
            ...
            @forelse ($peminjaman as $item)
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 space-x-2 text-center">
                        ...
                        <x-button.action href="{{ route('peminjaman.show', $item->id) }}" icon="eye" color="emerald"
                            title="Lihat Data" />
                        @endcanAccess

                        @canAccess('peminjaman', 'delete')
