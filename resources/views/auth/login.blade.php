    ...
    <div class="w-full max-w-6xl bg-gray-800 rounded-xl shadow-lg grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div class="p-10">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    <label for="username" class="block text-sm mb-1">Username <span
                ...
                <div>
                    <label for="password" class="block text-sm mb-1">Password <span
                            class="text-red-500">*</span></label>
                ...
                <div class="flex justify-between items-center text-sm text-gray-400">
                    <label>
                        <input type="checkbox" name="remember" class="mr-2 text-blue-500"> Keep me logged in
                    </label>
                </div>
        ...
        <div class="hidden md:flex  justify-center items-center bg-gray-900 text-center p-10">
            ...
            <h3 class="text-3xl font-bold text-white text-shadow-lg">
                SIGERCEP
            </h3>
        </div>
