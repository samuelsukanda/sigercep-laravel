            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="mb-0 font-bold text-lg">Edit Peminjaman</h6>
                    </div>
                    <div class="flex-auto p-6">
                        <form id="form" action="{{ route('peminjaman.update', $peminjaman->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                {{-- Status --}}
                                <x-form.select label="Status" name="status" :options="['Sudah Di Kembalikan', 'Belum Di Kembalikan']" :selected="old('status', $peminjaman->status)"
                                    ...
                                    <div class="border rounded shadow-sm bg-white p-4">
                                        ...
                                        @if ($peminjaman->tanda_tangan)
                                            <div id="current-signature-container" class="mb-4">
                                                ...
                                                <img id="signature-preview" src="{{ asset($peminjaman->tanda_tangan) }}"
                            ...
                            <div class="mt-6">
                                ...
                                <x-button.cancel type="button" class="ml-2 bg-gray-200"
                                    onclick="window.location='{{ route('peminjaman.index') }}'">
                                    Batal
                                </x-button.cancel>
                            </div>
                        </form>
