...
@section('content')
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex justify-between items-center mb-4 flex-wrap gap-2">
            {{-- Filter Tanggal --}}
            <form method="GET" action="{{ route('komite-medik.index') }}" class="flex items-center gap-4 mb-4">
                <div>
            ...
            <div class="filter">
                ...
                <select id="filter-unit"
                    ...
                    @foreach (config('units.komite_medik') as $unit)
