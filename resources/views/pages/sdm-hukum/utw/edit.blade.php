...
@section('title', 'SIGERCEP - Edit UTW')
            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div class="relative flex flex-col bg-white shadow-soft-xl rounded-2xl">
                    ...
                    <div class="flex-auto p-6">
                        <form action="{{ route('sdm-hukum.utw.update', $utw->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {{-- Nama File --}}
                                <x-form.input name="file_pdf" label="Nama File" :value="old('file_pdf', $utw->file_pdf ?? '')" required disabled />

                                {{-- Unit --}}
                                <x-form.select name="unit" label="Unit" :options="config('units.utw')" :selected="old('unit', $utw->unit)" required />
