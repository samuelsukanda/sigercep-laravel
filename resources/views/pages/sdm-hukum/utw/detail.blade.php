...
@section('title', 'SIGERCEP - Detail UTW')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col mb-4">
                                    <span>{{ \Carbon\Carbon::parse($utw->created_at)->translatedFormat('d F Y') }}</span>
                                    <span
                                        class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($utw->created_at)->format('H:i') }}
                                        WIB</span>
                                </div>
                            </div>
