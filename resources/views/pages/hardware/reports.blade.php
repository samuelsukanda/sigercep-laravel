        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                ...
                <div class="flex justify-between items-center mb-4">
                    <h3>Laporan Bulanan Ceklis Hardware</h3>
                </div>
                        ...
                        <form method="GET" action="{{ route('hardware.reports') }}" id="filterForm">
                            <div class="flex flex-wrap gap-3 items-end filter-wrap">
                                ...
                                <div class="flex flex-col mr-1 filter-item" style="min-width:148px; flex:1 1 148px; max-width:180px;">
                                    ...
                                    <select name="bulan" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        @php
                                            $months = [
                                ...
                                <div class="flex flex-col mr-1 filter-item" style="min-width:148px; flex:1 1 148px; max-width:180px;">
                                    ...
                                    <select name="tahun" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        @php
                                            $currentYear = date('Y');
                                ...
                                <div class="flex flex-col mr-1 filter-item" style="min-width:148px; flex:1 1 148px; max-width:180px;">
                                    ...
                                    <select name="lantai" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        <option value="">Semua Lantai</option>
                                        @foreach($listLantai as $lnt)
                                            <option value="{{ $lnt }}" {{ $selectedLantai == $lnt ? 'selected' : '' }}>
                                                {{ $lnt }}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="relative overflow-x-auto shadow-md rounded-lg px-2 bg-white dark:text-white">
                    <table class="datatable-custom min-w-full divide-y divide-gray-200 dark:divide-white-200 dark:text-white" id="datatable-reports">
                                    ...
                                    @foreach($pcMasters as $index => $pc)
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                @if($isChecked)
                                                    <i class="fas fa-check text-emerald-500 text-lg" style="color: #22c55e;" title="Sudah Dicek"></i>
                                                @else
                                            ...
                                            <td class="px-6 py-4 space-x-2 text-center">
                                                @if($isChecked)
                                                    <a href="{{ route('hardware.show', $hardwareId) }}" class="text-blue-500 hover:text-blue-700" title="Lihat Detail">
