...
@section('title', 'SIGERCEP - Edit Master Komputer')
            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div class="relative flex flex-col bg-white shadow-soft-xl rounded-2xl">
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="mb-0 font-bold text-lg">Edit Master Komputer</h6>
                    </div>
                    <div class="flex-auto p-6">
                        ...
                        <form action="{{ route('hardware.master-komputer.update', $master->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                {{-- Unit --}}
                                <x-form.input name="unit" label="Unit / Departemen" :value="old('unit', $master->unit)" />
