                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    <x-form.input type="number" step="any" name="mitigasi_nilai"
                                        label="Mitigasi Nilai (P x D x Bobot)" id="mnilai" :value="old('mitigasi_nilai', (float) $risiko->mitigasi_nilai)" readonly />
                                </div>

                                <div>
                                    <x-form.input type="number" step="any" name="mitigasi_bobot"
                                        label="Mitigasi Bobot" id="mbobot" :value="old('mitigasi_bobot', (float) $risiko->mitigasi_bobot)" oninput="calcMitigasi()" />
                                </div>
                                <div class="md:col-span-2">
