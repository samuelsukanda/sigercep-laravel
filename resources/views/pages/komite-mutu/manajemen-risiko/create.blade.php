...
@section('title', 'SIGERCEP - Tambah Manajemen Risiko')
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <form id="form" action="{{ route('komite-mutu.manajemen-risiko.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <x-form.input name="unit" label="Unit" :value="old('unit')" placeholder="Contoh: IGD"
                                    required />
                                ...
                                <div class="md:col-span-2">
                                    <x-form.textarea name="risiko" label="Risiko"
                                        required>{{ old('risiko') }}</x-form.textarea>
                                </div>

                                <x-form.input name="kode_risiko" label="Kode Risiko" :value="old('kode_risiko')" />
                                <x-form.input name="sumber_risiko" label="Sumber Risiko" :value="old('sumber_risiko')"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div class="md:col-span-3">
                                    <x-form.textarea name="pengendalian"
                                        label="Pengendalian Yang Ada">{{ old('pengendalian') }}</x-form.textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    <x-form.select name="analisis_tingkat" label="Tingkat Risiko Analisis" :options="[
                                        ...
                                        :selected="old('analisis_tingkat')" id="atingkat" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    <x-form.input type="number" step="any" name="mitigasi_nilai"
                                        label="Mitigasi Nilai (P x D)" id="mnilai" :value="old('mitigasi_nilai')" readonly />
                                </div>

                                <div>
                                    <x-form.input type="number" step="any" name="mitigasi_bobot"
                                        label="Mitigasi Bobot" :value="old('mitigasi_bobot')" />
                                </div>
                                <div class="md:col-span-2">
