                    ...
                    <div class="flex-auto p-6">
                        ...
                        <form id="form" action="{{ route('komite-mutu.manajemen-risiko.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <x-form.input name="unit" label="Unit" :value="old('unit')" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    <x-form.input type="number" step="any" name="analisis_nilai"
                                        label="Analisis Nilai (P x D x Bobot)" id="anilai" :value="old('analisis_nilai')" readonly />
                                </div>

                                <div>
                                    <x-form.input type="number" step="any" name="analisis_bobot" label="Analisis Bobot"
                                        id="abobot" :value="old('analisis_bobot')" oninput="calcAnalisis()" />
                                </div>
                                <div class="md:col-span-2">
