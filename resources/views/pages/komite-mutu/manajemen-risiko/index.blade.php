        ...
        <div
            ...
            <div class="overflow-x-auto custom-scrollbar p-6">
                <table class="w-full text-left border-collapse border border-gray-300 dark:border-slate-700">
                    <thead>
                        <tr
                            class="text-slate-400 dark:text-slate-300 text-xs font-bold uppercase bg-slate-50 dark:bg-slate-900/30">
                            ...
                            <th class="py-3 px-4 min-w-[150px] border border-gray-300 dark:border-slate-700">Kode Risiko
                            </th>
                            ...
                            <th class="py-3 px-4 min-w-[200px] border border-gray-300 dark:border-slate-700">Pengendalian
                            </th>
                            <th class="py-3 px-3 text-center min-w-[100px] border border-gray-300 dark:border-slate-700">
                                Tingkat<br>Analisis</th>
                            <th class="py-3 px-4 min-w-[150px] border border-gray-300 dark:border-slate-700">Target Waktu
                            </th>
                            <th class="py-3 px-3 text-center min-w-[100px] border border-gray-300 dark:border-slate-700">
                                Tingkat<br>Mitigasi</th>
                        ...
                        @forelse ($risikos as $item)
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-colors">
                                <td class="py-4 px-3 text-center border border-gray-300 dark:border-slate-700">
                                    <span
                                        class="block text-slate-700 dark:text-slate-300 text-xs">{{ $item->no_urut }}</span>
                                </td>

                                <td class="py-4 px-3 text-center border border-gray-300 dark:border-slate-700">
                                    <span
                                        class="block font-bold text-slate-700 dark:text-slate-300 text-xs">{{ $item->unit }}</span>
                                </td>
                                ...
                                <td
                                    class="py-4 px-4 text-xs text-slate-500 dark:text-slate-400 border border-gray-300 dark:border-slate-700">
                                    {{ $item->sebab }}
                                </td>
                                ...
                                <td
                                    ...
                                    {{ $item->pengendalian }}
                                    @if ($item->efektif)
                                        <span class="block mt-1 text-emerald-600 font-semibold"><i
                                                class="fas fa-check mr-1"></i> Efektif</span>
                                    @endif
                                    @if ($item->tidak_efektif)
                                        <span class="block mt-1 text-red-500 font-semibold"><i
                                ...
                                <td class="py-4 px-3 text-center border border-gray-300 dark:border-slate-700">
                                    ...
                                    @if ($item->analisis_nilai)
                                        <span class="block text-[10px] mt-1 text-slate-400">Skor:
                                            {{ (float) $item->analisis_nilai }}</span>
                                    @endif
                                </td>

                                <td
                                    class="py-4 px-4 text-xs font-medium text-slate-500 dark:text-slate-400 border border-gray-300 dark:border-slate-700 text-center">
                                    {{ $item->target_waktu ?? '-' }}
                                </td>
                            ...
                            <tr>
                                <td colspan="11"
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <span class="font-bold text-slate-400">Tidak ada data daftar risiko
                                            ditemukan.</span>
                                    </div>
                                </td>
                            </tr>
