                    ...
                    @foreach ($komplain as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 space-x-2 text-center">
                                <x-button.action href="{{ route('komplain.kesehatan-lingkungan.edit', $item->id) }}" icon="pen-to-square"
                                    color="emerald" title="Edit" />
                                <x-button.action href="{{ route('komplain.kesehatan-lingkungan.show', $item->id) }}" icon="eye"
                                    color="emerald" title="Lihat Data" />
                                <x-button.action href="{{ route('komplain.kesehatan-lingkungan.destroy', $item->id) }}" icon="trash"
