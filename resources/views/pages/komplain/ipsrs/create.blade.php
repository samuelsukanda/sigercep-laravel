                    ...
                    <div class="flex-auto p-6">
                        <form id="form" action="{{ route('komplain.ipsrs.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mt-6">
                                    <button type="submit"
                                        class="inline-block px-6 py-2 mb-0 text-xs font-semibold text-center text-slate-700 uppercase align-middle transition-all rounded-lg shadow-md hover:shadow-xs active:opacity-85">
                                        Simpan
                                    </button>
