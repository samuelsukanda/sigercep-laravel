...
@section('content')
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex justify-between items-center mb-4">
            ...
            <x-button.link href="{{ route('komplain.outsourcing-vendor.create') }}"
                    ...
                    @foreach ($komplain as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 space-x-2 text-center">
                                <x-button.action href="{{ route('komplain.outsourcing-vendor.edit', $item->id) }}" icon="pen-to-square"
                                ...
                                <x-button.action href="{{ route('komplain.outsourcing-vendor.destroy', $item->id) }}" icon="trash"
