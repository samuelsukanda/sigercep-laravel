...
@section('content')
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex justify-end items-center mb-4 flex-wrap gap-2">
            {{-- Filter Tanggal --}}
            <form method="GET" action="{{ route('reservasi.kendaraan.index') }}" class="flex items-center gap-4 mb-4">
                <div>
                ...
                <tbody class="text-s text-slate-500 bg-slate-100 dark:text-white">
                    @foreach ($reservasi as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                {{ \Carbon\Carbon::createFromFormat('H:i:s', $item->jam_pulang)->format('H:i') }}</td>
