...
// Saat halaman dimuat, baca localStorage dan atur mode awal
const savedTheme = localStorage.getItem("theme");
if (savedTheme === "dark") {
  root_html.classList.add("dark");
  if (dark_mode_toggle) dark_mode_toggle.checked = true;
} else {
  root_html.classList.remove("dark");
  if (dark_mode_toggle) dark_mode_toggle.checked = false;
}

// Saat toggle dark mode diubah, simpan ke localStorage
