...
let table = $("#dokumenItTable").DataTable({
    ...
    columns: [
        ...
        },
        {
            data: "jenis_dokumen",
            render: function (data) {
                return `<span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-semibold">${data}</span>`;
            },
        },
        {
        ...
        },
        {
            ...
            render: function (data) {
                ...
                if (data.can_update) {
                    btn += `
                    <a href="/dokumen-it/${data.id}/edit"
                ...
                if (data.can_delete) {
                    btn += `
                            <form action="/dokumen-it/${data.id}" method="POST" style="display:inline;">
