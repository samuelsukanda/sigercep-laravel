// public/assets/js/datatable/datatable-peraturan-perusahaan.js
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if (data.can_update) {
                        btn += `
                        <a href="/sdm-hukum/peraturan-perusahaan/${data.id}/edit"
                    ...
                    if (data.can_read) {
                        btn += `
                            <a href="/sdm-hukum/peraturan-perusahaan/${data.id}"
                    ...
                    if (data.can_delete) {
                        btn += `
                                <form action="/sdm-hukum/peraturan-perusahaan/${data.id}" method="POST" style="display:inline;">
