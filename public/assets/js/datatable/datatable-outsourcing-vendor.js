    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data) {
                ...
                if (data.can_update) {
                    btn += `
                    <a href="/komplain/outsourcing-vendor/${data.id}/edit"
                ...
                if (data.can_read) {
                    btn += `
                        <a href="/komplain/outsourcing-vendor/${data.id}"
                ...
                if (data.can_delete) {
                    btn += `
                            <form action="/komplain/outsourcing-vendor/${data.id}" method="POST" style="display:inline;">
