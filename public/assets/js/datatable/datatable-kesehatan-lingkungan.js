    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data) {
                ...
                if (data.can_update) {
                    btn += `
                    <a href="/komplain/kesehatan-lingkungan/${data.id}/edit"
                ...
                if (data.can_read) {
                    btn += `
                        <a href="/komplain/kesehatan-lingkungan/${data.id}"
                ...
                if (data.can_delete) {
                    btn += `
                            <form action="/komplain/kesehatan-lingkungan/${data.id}" method="POST" style="display:inline;">
